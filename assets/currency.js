...
;// CONCATENATED MODULE: ./src/js/modules/currency.js
...
class Currency {
  ...
  constructor() {
    ...
    _defineProperty(this, "storageKey", 'sf__currency_isocode');
    ...
    _defineProperty(this, "currencyCode", (_window = window) === null || _window === void 0 ? void 0 : (_window$Currency = _window.Currency) === null || _window$Currency === void 0 ? void 0 : (_window$Currency$shop = _window$Currency.shop) === null || _window$Currency$shop === void 0 ? void 0 : _window$Currency$shop.currencyCode);

    _defineProperty(this, "money_format", (_window2 = window) === null || _window2 === void 0 ? void 0 : (_window2$Currency = _window2.Currency) === null || _window2$Currency === void 0 ? void 0 : (_window2$Currency$sho = _window2$Currency.shop) === null || _window2$Currency$sho === void 0 ? void 0 : _window2$Currency$sho.money_format);

    _defineProperty(this, "money_with_currency_format", (_window3 = window) === null || _window3 === void 0 ? void 0 : (_window3$Currency = _window3.Currency) === null || _window3$Currency === void 0 ? void 0 : (_window3$Currency$sho = _window3$Currency.shop) === null || _window3$Currency$sho === void 0 ? void 0 : _window3$Currency$sho.money_with_currency_format);

    _defineProperty(this, "formats", ((_window4 = window) === null || _window4 === void 0 ? void 0 : (_window4$Currency = _window4.Currency) === null || _window4$Currency === void 0 ? void 0 : _window4$Currency.formats) || {});

    _defineProperty(this, "shop", ((_window5 = window) === null || _window5 === void 0 ? void 0 : (_window5$Currency = _window5.Currency) === null || _window5$Currency === void 0 ? void 0 : _window5$Currency.shop) || {});
    ...
    _defineProperty(this, "getCurrenciesFromThemeSettings", () => {
    ...
    _defineProperty(this, "setStoreCurrency", currencyCode => {
    ...
    _defineProperty(this, "saveCurrencyToStorage", () => {
      localStorage.setItem(this.storageKey, this.currencyCode);
    });

    _defineProperty(this, "updateStorePrices", (fromCurrency, toCurrency) => {
    ...
    _defineProperty(this, "setValueToPriceItem", (item, fromCurrency = this.shop.currencyCode, toCurrency = this.currencyCode) => {
      ...
      item.innerHTML = formatMoney(newValue, newMoneyFormat);
    });

    _defineProperty(this, "setSwitchersCurrency", currencyCode => {
    ...
    _defineProperty(this, "addEventToCurrenySwitchers", () => {
      [...this.domNodes.switchers].forEach(select => {
    ...
    _defineProperty(this, "addPriceItem", item => {
