...
class ProductCountdown {
  constructor(settings) {
    ...
    this.init();
    if (settings.show_flashsale && ((_window$spratlyThemeS = window.spratlyThemeSettings) === null || _window$spratlyThemeS === void 0 ? void 0 : _window$spratlyThemeS.template) === 'product' && !this.ended) this.initFlashSale();
  }
