...
class ProductBundle {
  constructor(container, settings) {
        ...
        handler: () => {
          ...
          fetch('/cart/add.js', config).then(async res => {
            ...
            if (!window.adminThemeSettings.use_ajax_atc) {
              ...
              const cartRoute = ((_window$spratlyThemeS2 = window.spratlyThemeSettings) === null || _window$spratlyThemeS2 === void 0 ? void 0 : (_window$spratlyThemeS3 = _window$spratlyThemeS2.routes) === null || _window$spratlyThemeS3 === void 0 ? void 0 : _window$spratlyThemeS3.cart) || '/cart';
    ...
    (0,defineProperty/* default */.Z)(this, "setTotalPrices", () => {
      ...
      } else if (active_discount && discount && discount.value) {
        if (discount.type === "PERCENTAGE") {
          discountedPrice = price * (100 - discount.value) / 100;
        } else if (discount.type === "FIXED_AMOUNT") {
          discountedPrice = price - discount.value * 100 * variants.length;
