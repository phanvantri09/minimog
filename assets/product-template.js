  ...
  constructor() {
    ...
    _defineProperty(this, "syncVariantWithMainProduct", () => {
      ...
      if (id) {
        ...
        window._ThemeEvent.subscribe(`${id}__VARIANT_CHANGE`, async (variant, prodInst) => {
          if (prodInst === this.mainProductInstance) {
            this.stickyATCProductInstance.updateBySelectedVariant(variant);
            const id = variant === null || variant === void 0 ? void 0 : variant.id;
...
class Sharing {
  constructor() {
    ...
    _defineProperty(this, "init", () => {
      var _this$domNodes$openBt;

      (_this$domNodes$openBt = this.domNodes.openBtn) === null || _this$domNodes$openBt === void 0 ? void 0 : _this$domNodes$openBt.classList.remove('hidden');
      this.modal = new modal();
      events_addEventDelegate({
