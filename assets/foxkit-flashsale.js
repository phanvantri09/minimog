...
function SaleProgress({
  ...
  }, createElement("div", null, createElement("span", null, sold, ": "), createElement("strong", {
    dataSet: {
      saleNumber: ''
    }
  }, soldNumb || 0)), createElement("div", null, createElement("span", null, available, ": "), createElement("strong", {
    dataSet: {
      availableNumber: ''
    }
  }, availableNumb || 10))));
...
register('foxkit-flashsale', {
  ...
  initCountdown: function () {
    ...
    load_assets_loadAssets('countdown.js').then(() => {
      ...
      this.Countdown = new window.spratlyTheme.ProductCountdown(this.settings);
