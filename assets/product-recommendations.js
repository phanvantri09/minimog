...
class ProductRecommendation {
  constructor(container, productHandles) {
    ...
    _defineProperty(this, "initProductCountdown", () => {
      load_assets_loadAssets('countdown.js').then(() => {
        ...
        return (_window = window) === null || _window === void 0 ? void 0 : (_window$spratlyTheme = _window.spratlyTheme) === null || _window$spratlyTheme === void 0 ? void 0 : (_window$spratlyTheme$ = _window$spratlyTheme.ProductCountdown) === null || _window$spratlyTheme$ === void 0 ? void 0 : (_window$spratlyTheme$2 = _window$spratlyTheme$.init) === null || _window$spratlyTheme$2 === void 0 ? void 0 : _window$spratlyTheme$2.call(_window$spratlyTheme$);
      });
    });
  ...
  async init() {
    ...
    if ((_this$productHandles2 = this.productHandles) !== null && _this$productHandles2 !== void 0 && _this$productHandles2.length) {
      var _window$spratlyTheme2, _window$spratlyTheme3;

      const {
        root
      } = window.spratlyThemeSettings.routes;
      const promises = this.productHandles.map(async handle => {
        const prodHTML = await fetchCache(`${root !== '/' ? root : ''}/products/${handle}?view=grid-card-item`);
      ...
      (_window$spratlyTheme2 = window.spratlyTheme) === null || _window$spratlyTheme2 === void 0 ? void 0 : (_window$spratlyTheme3 = _window$spratlyTheme2.Products) === null || _window$spratlyTheme3 === void 0 ? void 0 : _window$spratlyTheme3.initProductForms({
        context: this.container
      }).then(() => {
        var _window2, _window2$spratlyTheme, _window2$spratlyTheme2, _window3, _window3$spratlyTheme, _window3$spratlyTheme2, _this$container, _this$container$class;

        this.initByScreenSize();
        window.addEventListener('resize', debounce(this.initByScreenSize, 300));
        (_window2 = window) === null || _window2 === void 0 ? void 0 : (_window2$spratlyTheme = _window2.spratlyTheme) === null || _window2$spratlyTheme === void 0 ? void 0 : (_window2$spratlyTheme2 = _window2$spratlyTheme.CompareProduct) === null || _window2$spratlyTheme2 === void 0 ? void 0 : _window2$spratlyTheme2.setCompareButtonsState();
        (_window3 = window) === null || _window3 === void 0 ? void 0 : (_window3$spratlyTheme = _window3.spratlyTheme) === null || _window3$spratlyTheme === void 0 ? void 0 : (_window3$spratlyTheme2 = _window3$spratlyTheme.Wishlist) === null || _window3$spratlyTheme2 === void 0 ? void 0 : _window3$spratlyTheme2.setWishlistButtonsState();
