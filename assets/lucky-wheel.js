...
/* provided dependency */ var LuckyWheel_createElement = __webpack_require__(6295)["default"];
/* provided dependency */ var LuckyWheel_i18n = __webpack_require__(7345)["default"];
// eslint-disable-next-line no-unused-vars


function LuckyWheel_LuckyWheel({
  settings,
  handleClose,
  handleContinue
}) {
  ...
  return LuckyWheel_createElement("div", {
    ...
    className: 'pt-4 pb-6 lucky-wheel__agreement'
    ...
    className: 'lucky-wheel__submit uppercase sf__btn sf__btn-primary w-full'
...
/* provided dependency */ var lucky_wheel_createElement = __webpack_require__(6295)["default"];
...
class LuckyWheel {
  constructor(settings) {
    var _this$settings15, _this$settings16;
    ...
    (0,defineProperty/* default */.Z)(this, "handleAddEvents", () => {
      const {
        ...
        closeBtn,
        overlay
      } = this.domNodes; // Trigger play

      playBtn === null || playBtn === void 0 ? void 0 : playBtn.addEventListener('click', this.handleSubmit); // Close screen
    ...
    (0,defineProperty/* default */.Z)(this, "setupAnimation", () => {
      ...
      let wheel = '.lucky-wheel__spinner',
          ...
          currentRotation,
          lastRotation = 0,
          tolerance; // Creating the Timeline
    ...
    (0,defineProperty/* default */.Z)(this, "stopAt", () => {
      ...
      const total = prizes.reduce((acc, {
        chance
      }) => acc + chance, 0);
      const chances = prizes.reduce((acc, {
        chance
      }, index) => {
    ...
    (0,defineProperty/* default */.Z)(this, "handleOpen", () => {
      var _cookieData, _this$settings3, _this$settings5, _this$settings6;
      ...
      if (cookieData) cookieData = JSON.parse(cookieData); // Don't auto show popup

      if (cookieData && (_cookieData = cookieData) !== null && _cookieData !== void 0 && _cookieData.opened) {
        var _this$settings2, _cookieData2, _cookieData3;

        if ((_this$settings2 = this.settings) !== null && _this$settings2 !== void 0 && _this$settings2.teaser_activate && ((_cookieData2 = cookieData) === null || _cookieData2 === void 0 ? void 0 : _cookieData2.converted) !== true && ((_cookieData3 = cookieData) === null || _cookieData3 === void 0 ? void 0 : _cookieData3.dismissed) !== true) {
          this.showTeaser();
        }
      ...
      if (((_this$settings3 = this.settings) === null || _this$settings3 === void 0 ? void 0 : _this$settings3.trigger) === 'after_specific_time') {
        var _this$settings4;

        triggerAfterDelay((_this$settings4 = this.settings) === null || _this$settings4 === void 0 ? void 0 : _this$settings4.delay_show, this.open);
      } else if (((_this$settings5 = this.settings) === null || _this$settings5 === void 0 ? void 0 : _this$settings5.trigger) === 'after_scroll') {
        triggerAfterScroll(300, this.open);
      } else if (((_this$settings6 = this.settings) === null || _this$settings6 === void 0 ? void 0 : _this$settings6.trigger) === 'exit_intent') {
    ...
    (0,defineProperty/* default */.Z)(this, "handleShowPrize", () => {
      ...
      const prize = (_this$settings7 = this.settings) === null || _this$settings7 === void 0 ? void 0 : _this$settings7.prizes[this.lastIndex];
      ...
      if (prize) {
        ...
        if (hasCode) {
          ...
          this.domNodes.discountLabel.innerHTML = (_this$settings8 = this.settings) === null || _this$settings8 === void 0 ? void 0 : _this$settings8.lose_label;
        }
      }
    ...
    (0,defineProperty/* default */.Z)(this, "handleSubmit", async () => {
      ...
      if (validated) {
        var _this$settings9, _this$settings9$save_, _this$settings10, _this$settings10$save;

        const saveToApp = (_this$settings9 = this.settings) === null || _this$settings9 === void 0 ? void 0 : (_this$settings9$save_ = _this$settings9.save_to) === null || _this$settings9$save_ === void 0 ? void 0 : _this$settings9$save_.includes('foxkit_subscribers');
        const syncWithShopify = (_this$settings10 = this.settings) === null || _this$settings10 === void 0 ? void 0 : (_this$settings10$save = _this$settings10.save_to) === null || _this$settings10$save === void 0 ? void 0 : _this$settings10$save.includes('shopify_customers');
        const data = {
          email: emailVal,
          firstName: nameVal,
          birthday: birthVal,
    ...
    (0,defineProperty/* default */.Z)(this, "open", (shouldSetRepeatOpen = true) => {
      this.domNodes.screen.classList.add(this.classes.open);
      this.timeline.play();

      if (shouldSetRepeatOpen) {
        var _this$settings11;

        setRepeatOpen(this.saveKey, {
          opened: true,
          converted: false
        }, (_this$settings11 = this.settings) === null || _this$settings11 === void 0 ? void 0 : _this$settings11.repeat_open);
      }
    });
    ...
    (0,defineProperty/* default */.Z)(this, "showTeaser", () => {
      var _this$settings12, _this$settings13, _this$settings14;

      this.teaser = lucky_wheel_createElement(Teaser, {
        teaser_title: (_this$settings12 = this.settings) === null || _this$settings12 === void 0 ? void 0 : _this$settings12.teaser_title,
        teaser_position: (_this$settings13 = this.settings) === null || _this$settings13 === void 0 ? void 0 : _this$settings13.teaser_position,
        teaser_activate: (_this$settings14 = this.settings) === null || _this$settings14 === void 0 ? void 0 : _this$settings14.teaser_activate
      });
    ...
    if (((_this$settings15 = this.settings) === null || _this$settings15 === void 0 ? void 0 : _this$settings15.display_on) === 'home_only' && window.spratlyThemeSettings.template === 'index') {
      this.init();
    }

    if (((_this$settings16 = this.settings) === null || _this$settings16 === void 0 ? void 0 : _this$settings16.display_on) === 'all_pages') {
      this.init();
    }
  }
