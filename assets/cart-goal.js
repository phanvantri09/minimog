...
class CartGoal {
  constructor(settings) {
    ...
    (0,defineProperty/* default */.Z)(this, "init", () => {
      var _window$spratlyTheme, _window$spratlyTheme$, _window$FoxKit, _window$spratlyTheme2, _window$spratlyTheme3;

      this.enabled = (_window$spratlyTheme = window.spratlyTheme) === null || _window$spratlyTheme === void 0 ? void 0 : (_window$spratlyTheme$ = _window$spratlyTheme.Cart) === null || _window$spratlyTheme$ === void 0 ? void 0 : _window$spratlyTheme$.cart.requires_shipping;

      if (!this.enabled) {
        this.domNodes.cartGoal.classList.add('hidden');
      }

      this.updateProgress(((_window$FoxKit = window.FoxKit) === null || _window$FoxKit === void 0 ? void 0 : _window$FoxKit.newCart) || ((_window$spratlyTheme2 = window.spratlyTheme) === null || _window$spratlyTheme2 === void 0 ? void 0 : (_window$spratlyTheme3 = _window$spratlyTheme2.Cart) === null || _window$spratlyTheme3 === void 0 ? void 0 : _window$spratlyTheme3.cart));
      this.listenCartChange();
      this.confettiShow = this.goalDone;
    });

    (0,defineProperty/* default */.Z)(this, "updateProgress", cart => {
      var _cart$_foxCartPrices, _window$spratlyThemeS;
      ...
      this.goalTitle = this.goalTitle.replace('{{variable}}', `<strong>${formatMoney(this.goalLeft, (_window$spratlyThemeS = window.spratlyThemeSettings) === null || _window$spratlyThemeS === void 0 ? void 0 : _window$spratlyThemeS.money_format)}</strong>`);
      setTimeout(() => this.domNodes.title.innerHTML = this.goalTitle, 500);
      this.setDone();
    });

    (0,defineProperty/* default */.Z)(this, "listenCartChange", () => {
      window._ThemeEvent.subscribe('ON_FOX_CART_UPDATE', async cart => {
        if (cart) {
    ...
    (0,defineProperty/* default */.Z)(this, "showConfetti", () => {
      if (this.enabled && !this.confettiShow && window.spratlyThemeSettings.template !== 'cart') {
